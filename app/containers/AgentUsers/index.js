          ...
          <div className="table-wrapper">
            <div className="flex items-center gap-3 justify-between mb-5">
              <button
                ...
                onClick={() => navigate('/agent-users/add-user/2')}
              >
                  ...
                  {agentList?.length > 0 ? (
                    agentList.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td className="!w-[150px]">{item.mobile ?? 'N/A'}</td>
                        <td className="!w-[320px]">{item.email ?? 'N/A'}</td>
                        <td>{item.country ?? 'N/A'}</td>
                        <td>
                          {item.createdByType === 'admin' ? 'Admin' : 'Agent'}
                        </td>
                          ...
                          <ActionButton
                            option={[
                              ...
                              },
                              {
                                ...
                                onClick: () =>
                                  navigate('/agent-user-transaction'),
                              },
                              {
                                label: 'Bet History',
                                value: 'Bet History',
