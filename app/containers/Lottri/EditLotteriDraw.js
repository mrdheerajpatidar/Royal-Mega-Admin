...
const EditLotteriDraw = () => {
  ...
  const [payload, setPayload] = useState({ type: 'Lottery' });
          ...
          if (response?.status) {
            ...
            if (draw) {
              setForm({
                ...
                endTime: moment(draw?.endTime).format('YYYY-MM-DDTHH:mm'),
              });
            }
          }
          return null;
    ...
    <>
      ...
      <div>
        <header className="flex items-center gap-3 mb-5">
          ...
          <h1 className="page-title ">Edit Lottri Draw</h1>
        </header>
...
export default EditLotteriDraw;
