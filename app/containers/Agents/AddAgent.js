...
const AddAgent = () => {
  ...
  const addAgentHandler = async (e) => {
    ...
    try {
      ...
      const [valid, error] = await validateData(addAgentValidation, form);
      ...
      const payload = {
        ...
        // winningPercentage: Number(form.winningPercentage),
      ...
      if (valid) {
        ...
        if (error) {
          ...
          toast.success('Agent registered successfully', { toastId: 6 });
          ...
          <div className="border border-primary-200 py-4 px-5 rounded-12">
            ...
            >
              ...
              {/* <div className="input-group">
                <InputField
                  type="number"
                  label="Winning Comission"
                  labelClassName="!text-white"
                  name="winningPercentage"
                  errMsg={renderError(formErr.winningPercentage)}
                  wrapperClassName="!mb-0"
                  placeholder="%"
                  className="bg-black rounded-lg  text-white"
                  onChange={handleChange}
